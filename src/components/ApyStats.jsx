        ...
        const terra = new LCDClient({
          ...
          for (let index = state.currentLotteryId - 8; index < state.currentLotteryId; index++) {
            ...
            for (let i = 2; i < 5; i++) {               
                ...
                await tmpWinnerData.push({rank: i, lottery_id: index, data:{contractWinnersInfo}}) 
                await timer(250);
            }
            ...
            await tmpJackpotData.push({lottery_id: index, jackpot: contractJackpotInfo})
                ...
                tmpWinnerData.map((o,i) => {
                    if(o.lottery_id == obj.lottery_id){
                        if(parseInt(o.data.contractWinnersInfo) > 0){
                            winners.push({rank:o.rank, winners:o.data.contractWinnersInfo})
                        }
                    }
                })
