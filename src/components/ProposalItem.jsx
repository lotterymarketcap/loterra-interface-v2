                        ...
                        <table className="table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {(
                                            (parseInt(data.weight_yes_vote) *
                                                100) /
                                            parseInt(
                                                state.staking.total_balance
                                            )
                                        ).toFixed(0)}
                                        % of 50%
                                    </td>
                    ...
                    <div className="vote-box align-self-center w-100">
                        ...
                        <div className="progress">
                            <div
                                ...
                                aria-valuemin="0"
                                aria-valuemax={
                                    data.weight_yes_vote + data.weight_no_vote
                                }
                            >
                                YES
                            </div>
                                ...
                                data.status != 'Rejected' ? (
                                    <>
                                        <button
                                            ...
                                            onClick={() => vote(true, data.nr)}
                                        >
                                            Yes
                                        </button>
                                        <button
                                            className="btn btn-plain"
                                            onClick={() => vote(false, data.nr)}
                                        >
                                            No
                                        </button>
                                    </>
                                ) : (
                                    <button className="btn btn-plain" disabled>
                                        {data.status}
                                    </button>
                                )}
